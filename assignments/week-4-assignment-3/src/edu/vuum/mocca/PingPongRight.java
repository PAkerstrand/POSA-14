...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
        ...
        public void run() {
            ...
            // TODO - You fill in here.
            for(int currLoop = 1; currLoop <= mMaxLoopIterations; ++currLoop) {
                acquire();
                printOutput(currLoop);
                release();
            }
            mLatch.countDown();
        }

        private void printOutput(int iteration) {
            System.out.println(mStringToPrint + "(" + iteration + ")");
        }
