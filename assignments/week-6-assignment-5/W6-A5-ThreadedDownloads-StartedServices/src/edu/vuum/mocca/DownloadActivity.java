...
public class DownloadActivity extends DownloadBase {
    ...
    static class MessengerHandler extends Handler {
         ...
         *
         * @link https://groups.google.com/forum/#!msg/android-developers/1aPZXZG6kWk/lIYDavGYn5UJ
         */
        ...
        public void handleMessage(Message msg) {
            ...
            if (activity != null) {
                ...
                if (msg.getData() != null) {
                    ...
                    if (pathName != null) {
                        // The message handler is bound to the UI thread, so no need to use `runOnUiThread()`
